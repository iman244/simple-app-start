...
const hotels_schema_1 = require("../hotels/hotels.schema");
let Room = class Room {
};
__decorate([
    (0, mongoose_1.Prop)(),
...
__decorate([
    (0, mongoose_1.Prop)({ type: mongoose.Schema.Types.ObjectId, ref: 'Hotels' }),
    __metadata("design:type", hotels_schema_1.Hotel)
